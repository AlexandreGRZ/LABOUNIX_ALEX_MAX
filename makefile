...
Gerant:	maingerant.o windowgerant.o moc_windowgerant.o SemPham.o
		g++ -Wno-unused-parameter SemPham.o  -o Gerant maingerant.o windowgerant.o moc_windowgerant.o /usr/lib64/libQt5Widgets.so /usr/lib64/libQt5Gui.so /usr/lib64/libQt5Core.so /usr/lib64/libGL.so -L/usr/lib64/mysql -lmysqlclient -lpthread -lz -lm -lrt -lssl -lcrypto -ldl
...
Serveur:	Serveur.cpp FicheClient.o SemPham.o
		g++ SemPham.o Serveur.cpp FicheClient.o -o Serveur -I/usr/include/mysql -m64 -L/usr/lib64/mysql -lmysqlclient -lpthread -lz -lm -lrt -lssl -lcrypto -ldl

FicheClient.o:	FicheClient.cpp FicheClient.h
		g++ FicheClient.cpp -c
...
SemPham.o:	SemPham.cpp SemPham.h
		g++	SemPham.cpp -c